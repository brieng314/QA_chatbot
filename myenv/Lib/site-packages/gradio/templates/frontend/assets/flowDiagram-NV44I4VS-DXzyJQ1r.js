...
`);return Ot.parse(i)};var be=Mt,Ae=A((t,i)=>{const r=ce,a=r(t,"r"),o=r(t,"g"),d=r(t,"b");return ue(a,o,d,i)},"fade"),ke=A(t=>`.label {
  ...
  ${Yt()}
`,"getStyles"),me=ke,ve={parser:be,get db(){return new de},renderer:ge,styles:me,init:A(t=>{t.flowchart||(t.flowchart={}),t.layout&&Pt({layout:t.layout}),t.flowchart.arrowMarkerAbsolute=t.arrowMarkerAbsolute,Pt({flowchart:{arrowMarkerAbsolute:t.arrowMarkerAbsolute}})},"init")};export{ve as diagram};
